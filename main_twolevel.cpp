...
void usage(){
    cerr << "NAME" << endl;
    cerr << "       ./twoLevel - k-NN query using the 2-level algorithm" << endl << endl;
    cerr << "USAGE" << endl;
    ...
    cerr << "       -f" << endl;
    cerr << "              number of k neighbors" << endl;
    cerr << "       -w" << endl;
    cerr << "              object and query point datasets" << endl;
    ...
    cerr << "EXAMPLES" << endl;
    cerr << "       10-NN query using the 2-level algorithm with 150 partitions per dimension." << endl;
    cerr << "              ./twoLevel -p 150 -f 10 -w datasets/PRIMARY_ROADS_mbr.csv datasets/USA_c1%_n10000.qry" << endl;
    cerr << "\n" << endl;
    exit(1);
}
    ...
    switch (queryMethod)
    {
        case NEAREST:
            ...
            for (size_t i = 0; i < S.size(); i++) {
                ...
                if (NUM_ITERATIONS > 0 && NUM_ITERATIONS < 2)
                    timeKNNalgorithm = sum;
                else 
